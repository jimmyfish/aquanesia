...
<head>
    ...
    <link class="main-stylesheet" href="{{ asset('/css/light.css') }}" rel="stylesheet" type="text/css"/>
</head>
    ...
    <div class="header ">
        ...
        <div class="">
            <div class="brand inline">
                <img src="{{ asset('img/aqualogo.svg') }}" alt="logo" data-src="{{ asset('img/aqualogo.svg') }}"
                     data-src-retina="{{ asset('img/aqualogo.svg') }}" width="78" height="22">
            </div>
                                        ...
                                        <div class="heading">
                                            <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                                                <img width="30" height="30"
                                                     data-src-retina="{{ asset('img/profiles/1x.jpg') }}"
                                                     data-src="{{ asset('img/profiles/1.jpg') }}" alt=""
                                                     src="{{ asset('img/profiles/1.jpg') }}">
                                            </div>
                                            <a href="#" class="text-primary pull-left">
                ...
                <div class="view bg-white">
                    ...
                    <div data-init-list-view="ioslist" class="list-view boreded no-top-border">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('img/profiles/1x.jpg') }}"
                                 data-src="{{ asset('img/profiles/1.jpg') }}" src="{{ asset('img/profiles/1x.jpg') }}"
                                 class="col-top">
                        </span>
                                        <p class="p-l-10 ">
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                       class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('img/profiles/2x.jpg') }}"
                                 data-src="{{ asset('img/profiles/2.jpg') }}" src="{{ asset('img/profiles/2x.jpg') }}"
                                 class="col-top">
                        </span>
                                        <p class="p-l-10 ">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                       class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('img/profiles/3x.jpg') }}"
                                 data-src="{{ asset('img/profiles/3.jpg') }}" src="{{ asset('img/profiles/3x.jpg') }}"
                                 class="col-top">
                        </span>
                                        <p class="p-l-10 ">
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                       class="" href="#">
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt="" data-src-retina="{{ asset('img/profiles/4x.jpg') }}"
                                                 data-src="{{ asset('img/profiles/4.jpg') }}" src="{{ asset('img/profiles/4x.jpg') }}"
                                                 class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                       class="" href="#">
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt="" data-src-retina="{{ asset('img/profiles/5x.jpg') }}"
                                                 data-src="{{ asset('img/profiles/5.jpg') }}" src="{{ asset('img/profiles/5x.jpg') }}"
                                                 class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                    ...
                    <div class="chat-inner" id="my-conversation">
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30" src="{{ asset('img/profiles/avatar_small.jpg') }}"
                                     alt="" data-src="{{ asset('img/profiles/avatar_small.jpg') }}"
                                     data-src-retina="{{ asset('img/profiles/avatar_small2x.jpg') }}">
                            </div>
...
<div class="overlay hide" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
            <!-- BEGIN Overlay Logo !-->
            <img class="overlay-brand" src="{{ asset('img/aqualogo.svg') }}" alt="logo" data-src="{{ asset('img/aqualogo.svg') }}"
                 data-src-retina="{{ asset('img/aqualogo.svg') }}" width="78" height="22">
            <!-- END Overlay Logo !-->
            <!-- BEGIN Overlay Close !-->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            ...
                            <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                                <div>
                                    <img width="50" height="50" src="{{ asset('img/profiles/avatar.jpg') }}"
                                         data-src="{{ asset('img/profiles/avatar.jpg') }}"
                                         data-src-retina="{{ asset('img/profiles/avatar2x.jpg') }}" alt="">
                                </div>
                            </div>
...
<!-- BEGIN PAGE LEVEL JS -->
<script src="{{ mix('js/scripts.js') }}" type="text/javascript"></script>
